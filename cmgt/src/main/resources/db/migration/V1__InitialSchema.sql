...
create table student_courses (course_id integer not null, student_id integer not null, enrolled_time datetime, grade double precision not null, project_grade double precision not null, primary key (course_id, student_id))  ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
alter table student_courses add constraint FKiqufqwgb6im4n8xslhjvxmt0n foreign key (student_id) references student (id) ON DELETE CASCADE;